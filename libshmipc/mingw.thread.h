...
* happens,
* the appropriate license will be added, i.e. this code will become
* dual-licensed,
...
class thread {
 ...
 public:
  ...
  explicit thread(Function&& f, Args&&... args) {
    ...
    mHandle = (HANDLE)_beginthreadex(NULL, 0, threadfunc<Call>, (LPVOID)call, 0,
...
void sleep_for(const std::chrono::duration<Rep, Period>& sleep_duration) {
  Sleep(std::chrono::duration_cast<std::chrono::milliseconds>(sleep_duration)
            .count());
}
