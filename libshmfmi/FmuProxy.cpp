...
bool FmuProxy::initialize() { return this->server->create(); }

#define OVERFLOW_CHECK_RETURN_NULL \
	if(m.protoBufMsgSize > SharedFmiBufferSize)\
	{\
		std::cerr << "Shared memory buffer overflow. Prorobuf message too big" << std::endl;\
		return NULL;\
	}

google::protobuf::Message* FmuProxy::send(sharedfmimemory::fmi2Command type,
  ...
  if (reply == NULL) return NULL;  // timeout
...
FmuProxy::fmi2Status FmuProxy::sendRetStatus(sharedfmimemory::fmi2Command type,
                                             google::protobuf::Message* msg) {
  Fmi2StatusReply* reply = (Fmi2StatusReply*)send(type, msg);

  if (reply == NULL) return fmi2Fatal;
...
bool FmuProxy::fmi2Instantiate(fmi2String instanceName, fmi2String fmuGUID,
  ...
  Fmi2StatusReply* reply =
      (Fmi2StatusReply*)send(sharedfmimemory::fmi2Instantiate, &request);

  if (reply == NULL || getStatus(reply) != fmi2OK) return false;

  return true;
}

FmuProxy::fmi2Status FmuProxy::fmi2SetupExperiment(fmi2Boolean toleranceDefined,
                                                   fmi2Real tolerance,
                                                   fmi2Real startTime,
...
// get
//
FmuProxy::fmi2Status FmuProxy::fmi2GetReal(const fmi2ValueReference vr[],
                                           size_t nvr, fmi2Real value[]) {
  Fmi2GetRequest request = createGetRequest(vr, nvr);

  Fmi2GetRealReply* reply =
      (Fmi2GetRealReply*)send(sharedfmimemory::fmi2GetReal, &request);
...
FmuProxy::fmi2Status FmuProxy::fmi2GetInteger(const fmi2ValueReference vr[],
                                              size_t nvr, fmi2Integer value[]) {
  Fmi2GetRequest request = createGetRequest(vr, nvr);

  Fmi2GetIntegerReply* reply =
      (Fmi2GetIntegerReply*)send(sharedfmimemory::fmi2GetInteger, &request);
...
FmuProxy::fmi2Status FmuProxy::fmi2GetBoolean(const fmi2ValueReference vr[],
                                              size_t nvr, fmi2Boolean value[]) {
  Fmi2GetRequest request = createGetRequest(vr, nvr);

  Fmi2GetBooleanReply* reply =
      (Fmi2GetBooleanReply*)send(sharedfmimemory::fmi2GetBoolean, &request);
...
FmuProxy::fmi2Status FmuProxy::fmi2GetString(const fmi2ValueReference vr[],
                                             size_t nvr, fmi2String value[]) {
  Fmi2GetRequest request = createGetRequest(vr, nvr);

  Fmi2GetStringReply* reply =
      (Fmi2GetStringReply*)send(sharedfmimemory::fmi2GetString, &request);

  if (reply == NULL|| !reply->valid()) return fmi2Fatal;
...
FmuProxy::fmi2Status FmuProxy::fmi2SetReal(const fmi2ValueReference vr[],
...
FmuProxy::fmi2Status FmuProxy::fmi2SetInteger(const fmi2ValueReference vr[],
                                              size_t nvr,
...
FmuProxy::fmi2Status FmuProxy::fmi2SetBoolean(const fmi2ValueReference vr[],
                                              size_t nvr,
...
FmuProxy::fmi2Status FmuProxy::fmi2SetString(const fmi2ValueReference vr[],
                                             size_t nvr,
...
FmuProxy::fmi2Status FmuProxy::fmi2GetRealStatus(const fmi2StatusKind s,
                                                 fmi2Real* value) {
  Fmi2StatusRequest request = createGetStatusRequest(s);

  Fmi2RealStatusReply* reply =
      (Fmi2RealStatusReply*)send(sharedfmimemory::fmi2GetRealStatus, &request);
...
FmuProxy::fmi2Status FmuProxy::fmi2GetIntegerStatus(const fmi2StatusKind s,
                                                    fmi2Integer* value) {
  Fmi2StatusRequest request = createGetStatusRequest(s);
...
FmuProxy::fmi2Status FmuProxy::fmi2GetBooleanStatus(const fmi2StatusKind s,
                                                    fmi2Boolean* value) {
  Fmi2StatusRequest request = createGetStatusRequest(s);
...
FmuProxy::fmi2Status FmuProxy::fmi2GetStringStatus(const fmi2StatusKind s,
                                                   fmi2String* value) {
  Fmi2StatusRequest request = createGetStatusRequest(s);
...
void FmuProxy::fmi2FreeInstance() {
  ...
  // semaphores get into an invalid state
  this->server->send(&m, 1);
}

FmiIpc::IpcBase* FmuProxy::getChannel() { return this->server; }
