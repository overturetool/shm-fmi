...
private:
	...
	google::protobuf::Message* send(sharedfmimemory::fmi2Command type,google::protobuf::Message* msg);
	ExternalClient::fmi2Status sendRetStatus(sharedfmimemory::fmi2Command type, google::protobuf::Message* msg);
};
